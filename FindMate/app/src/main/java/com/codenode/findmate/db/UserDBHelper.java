...
public class UserDBHelper extends SQLiteOpenHelper {
   ...
   public long insert(List<UserInfo> infoList) {
      ...
      for (int i = 0; i < infoList.size(); i++) {
         ...
         if (userInfo.userName != null && userInfo.userName.length() > 0) {
            String condition = String.format("userName='%s'", userInfo.userName);
   ...
   public List<UserInfo> query(String condition) {
      String sql = String.format("select rowid,_id,userName,email,password,update_time" +
